...
let pp10 = document.getElementById("pp10");
let pp11 = document.getElementById("pp11");
let b1 = document.getElementById("b1");
let b2 = document.getElementById("b2");
let modedark = document.getElementById("m1");
let modelight = document.getElementById("m2");
let lightpage = document.getElementById("lightp");
let darkpage = document.getElementById("darkp");
...
b1.onclick = function () {
  ...
  } else if (pp10.style.display === "block") {
    pp10.style.display = "none";
    pp9.style.display = "block";
  } else if (pp11.style.display === "block") {
